#
# Podspec for the macOS slice of the jmdict_fast Flutter plugin.
...
jmdict-fast Rust engine via flutter_rust_bridge.
  ...
  # Classes/ holds the FFI forwarder; the real Rust artifact is produced
  # by the script_phase below and linked in via -force_load.
  s.source           = { :path => '.' }
